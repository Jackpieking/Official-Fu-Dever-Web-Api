...
/// <summary>
///     Is user locked out query model validator.
/// </summary>
public sealed class IsUserLockedOutQueryValidator : AbstractValidator<IsUserLockedOutQuery>
{
    public IsUserLockedOutQueryValidator()
    {
