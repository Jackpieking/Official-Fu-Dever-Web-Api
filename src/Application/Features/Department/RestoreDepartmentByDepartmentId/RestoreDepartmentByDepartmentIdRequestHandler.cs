...
/// </summary>
internal sealed class RestoreDepartmentByDepartmentIdRequestHandler : IRequestHandler<
    ...
    RestoreDepartmentByDepartmentIdResponse>
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        if (!isDepartmentFoundByDepartmentId)
        {
            return new()
            {
                StatusCode = RestoreDepartmentByDepartmentIdResponseStatusCode.DEPARTMENT_IS_NOT_FOUND
            };
        }
        ...
        if (!isDepartmentTemporarilyRemoved)
        {
            return new()
            {
                StatusCode = RestoreDepartmentByDepartmentIdResponseStatusCode.DEPARTMENT_IS_NOT_TEMPORARILY_REMOVED
            };
        }
        ...
        if (!result)
        {
            return new()
            {
                StatusCode = RestoreDepartmentByDepartmentIdResponseStatusCode.DATABASE_OPERATION_FAIL
            };
        }
