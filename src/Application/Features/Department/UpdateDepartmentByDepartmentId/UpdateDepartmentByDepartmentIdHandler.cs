...
/// </summary>
internal sealed class UpdateDepartmentByDepartmentIdHandler : IRequestHandler<
    ...
    UpdateDepartmentByDepartmentIdResponse>
{
    ...
    public UpdateDepartmentByDepartmentIdHandler(
        ...
        CancellationToken cancellationToken)
    {
        ...
        if (!isDepartmentFoundByDepartmentId)
        {
            return new()
            {
                StatusCode = UpdateDepartmentByDepartmentIdStatusCode.DEPARTMENT_IS_NOT_FOUND
            };
        }
        ...
        if (isDepartmentTemporarilyRemoved)
        {
            return new()
            {
                StatusCode = UpdateDepartmentByDepartmentIdStatusCode.DEPARTMENT_IS_ALREADY_TEMPORARILY_REMOVED
            };
        }
        ...
        if (isDepartmentWithTheSameNameFound)
        {
            return new()
            {
                StatusCode = UpdateDepartmentByDepartmentIdStatusCode.DEPARTMENT_ALREADY_EXISTS
            };
        }
        ...
        if (!result)
        {
            return new()
            {
                StatusCode = UpdateDepartmentByDepartmentIdStatusCode.DATABASE_OPERATION_FAIL
            };
        }

        return new()
        {
            StatusCode = UpdateDepartmentByDepartmentIdStatusCode.OPERATION_SUCCESS
        };
    }
        ...
        await _unitOfWork
            ...
            .ExecuteAsync(operation: async () =>
            {
                try
                {
                    ...
                    await _unitOfWork.DepartmentRepository.BulkUpdateByDepartmentIdVer2Async(
                        departmentId: request.DepartmentId,
