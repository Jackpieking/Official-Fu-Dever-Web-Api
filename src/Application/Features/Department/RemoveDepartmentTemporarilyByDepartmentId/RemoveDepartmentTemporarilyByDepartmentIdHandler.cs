...
/// </summary>
internal sealed class RemoveDepartmentTemporarilyByDepartmentIdHandler : IRequestHandler<
    ...
    RemoveDepartmentTemporarilyByDepartmentIdResponse>
{
    ...
    public RemoveDepartmentTemporarilyByDepartmentIdHandler(
        ...
        CancellationToken cancellationToken)
    {
        ...
        if (!isDepartmentFound)
        {
            return new()
            {
                StatusCode = RemoveDepartmentTemporarilyByDepartmentIdStatusCode.DEPARTMENT_IS_NOT_FOUND
            };
        }
        ...
        if (isDepartmentTemporarilyRemoved)
        {
            return new()
            {
                StatusCode = RemoveDepartmentTemporarilyByDepartmentIdStatusCode.DEPARTMENT_IS_ALREADY_TEMPORARILY_REMOVED
            };
        }
        ...
        if (!result)
        {
            return new()
            {
                StatusCode = RemoveDepartmentTemporarilyByDepartmentIdStatusCode.DATABASE_OPERATION_FAIL
            };
        }

        return new()
        {
            StatusCode = RemoveDepartmentTemporarilyByDepartmentIdStatusCode.OPERATION_SUCCESS
        };
    }
