...
/// </summary>
internal sealed class RemoveDepartmentPermanentlyByDepartmentIdHandler : IRequestHandler<
    ...
    RemoveDepartmentPermanentlyByDepartmentIdResponse>
{
    ...
    public RemoveDepartmentPermanentlyByDepartmentIdHandler(
        ...
        CancellationToken cancellationToken)
    {
        ...
        if (!isDepartmentFoundByDepartmentId)
        {
            return new()
            {
                StatusCode = RemoveDepartmentPermanentlyByDepartmentIdStatusCode.DEPARTMENT_IS_NOT_FOUND
            };
        }
        ...
        if (!isDepartmentTemporarilyRemoved)
        {
            return new()
            {
                StatusCode = RemoveDepartmentPermanentlyByDepartmentIdStatusCode.DEPARTMENT_IS_NOT_TEMPORARILY_REMOVED
            };
        }
        ...
        if (!result)
        {
            return new()
            {
                StatusCode = RemoveDepartmentPermanentlyByDepartmentIdStatusCode.DATABASE_OPERATION_FAIL
            };
        }

        return new()
        {
            StatusCode = RemoveDepartmentPermanentlyByDepartmentIdStatusCode.OPERATION_SUCCESS
        };
    }
