...
/// </summary>
internal sealed class UpdatePositionByPositionIdHandler : IRequestHandler<
    ...
    UpdatePositionByPositionIdResponse>
{
    ...
    public UpdatePositionByPositionIdHandler(
        ...
        CancellationToken cancellationToken)
    {
        ...
        if (!isPositionFoundByPositionId)
        {
            return new()
            {
                StatusCode = UpdatePositionByPositionIdStatusCode.POSITION_IS_NOT_FOUND
            };
        }
        ...
        if (isPositionTemporarilyRemoved)
        {
            return new()
            {
                StatusCode = UpdatePositionByPositionIdStatusCode.POSITION_IS_ALREADY_TEMPORARILY_REMOVED
            };
        }
        ...
        if (isPositionWithTheSameNameFound)
        {
            return new()
            {
                StatusCode = UpdatePositionByPositionIdStatusCode.POSITION_ALREADY_EXISTS
            };
        }
        ...
        if (!result)
        {
            return new()
            {
                StatusCode = UpdatePositionByPositionIdStatusCode.DATABASE_OPERATION_FAIL
            };
        }

        return new()
        {
            StatusCode = UpdatePositionByPositionIdStatusCode.OPERATION_SUCCESS
        };
    }
