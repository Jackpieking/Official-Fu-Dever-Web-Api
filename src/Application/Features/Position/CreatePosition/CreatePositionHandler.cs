...
/// </summary>
internal sealed class CreatePositionHandler : IRequestHandler<
        ...
        CancellationToken cancellationToken)
    {
        ...
        if (isPositionFound)
        {
            ...
            if (isPositionTemporarilyRemoved)
            {
                return new()
                {
                    StatusCode = CreatePositionStatusCode.POSITION_IS_ALREADY_TEMPORARILY_REMOVED
                };
            }

            return new()
            {
                StatusCode = CreatePositionStatusCode.POSITION_ALREADY_EXISTS
            };
        }
        ...
        if (!result)
        {
            return new()
            {
                StatusCode = CreatePositionStatusCode.DATABASE_OPERATION_FAIL
            };
        }

        return new()
        {
            StatusCode = CreatePositionStatusCode.OPERATION_SUCCESS
        };
    }
