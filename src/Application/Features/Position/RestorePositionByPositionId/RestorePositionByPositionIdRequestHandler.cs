...
/// </summary>
internal sealed class RestorePositionByPositionIdRequestHandler : IRequestHandler<
    ...
    RestorePositionByPositionIdResponse>
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        if (!isPositionTemporarilyRemoved)
        {
            return new()
            {
                StatusCode = RestorePositionByPositionIdResponseStatusCode.POSITION_IS_NOT_TEMPORARILY_REMOVED
            };
        }
