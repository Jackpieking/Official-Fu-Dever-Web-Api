...
/// </summary>
internal sealed class GetAllTemporarilyRemovedPositionsHandler : IRequestHandler<
    ...
    GetAllTemporarilyRemovedPositionsResponse>
{
    ...
    public GetAllTemporarilyRemovedPositionsHandler(
        ...
        CancellationToken cancellationToken)
    {
        ...
        return new()
        {
            StatusCode = GetAllTemporarilyRemovedPositionsStatusCode.OPERATION_SUCCESS,
