...
/// </summary>
internal sealed class GetAllPositionsByPositionNameHandler : IRequestHandler<
    ...
    GetAllPositionsByPositionNameResponse>
{
    ...
    public GetAllPositionsByPositionNameHandler(
        ...
        CancellationToken cancellationToken)
    {
        ...
        return new()
        {
            StatusCode = GetAllPositionsByPositionNameStatusCode.OPERATION_SUCCESS,
