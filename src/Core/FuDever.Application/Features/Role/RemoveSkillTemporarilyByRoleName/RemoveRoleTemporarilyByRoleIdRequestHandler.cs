    ...
    RemoveRoleTemporarilyByRoleIdResponse>
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        if (!isRoleFound)
        {
            return new()
            {
                StatusCode = RemoveRoleTemporarilyByRoleIdResponseStatusCode.DEPARTMENT_IS_NOT_FOUND
            };
        }
        ...
        if (isRoleTemporarilyRemoved)
        {
            return new()
            {
                StatusCode = RemoveRoleTemporarilyByRoleIdResponseStatusCode.DEPARTMENT_IS_ALREADY_TEMPORARILY_REMOVED
            };
        }
