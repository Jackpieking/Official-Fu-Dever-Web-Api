...
using Persistence.Database.SqlServer.Specifications.Entities.Blog.Manager;
using Persistence.Database.SqlServer.Specifications.Entities.Cv.Manager;
using Persistence.Database.SqlServer.Specifications.Entities.Department.Manager;
using Persistence.Database.SqlServer.Specifications.Entities.Hobby.Manager;
using Persistence.Database.SqlServer.Specifications.Entities.Major.Manager;
using Persistence.Database.SqlServer.Specifications.Entities.Platform.Manager;
using Persistence.Database.SqlServer.Specifications.Entities.Position.Manager;
using Persistence.Database.SqlServer.Specifications.Entities.Project.Manager;
using Persistence.Database.SqlServer.Specifications.Entities.RefreshToken.Manager;
using Persistence.Database.SqlServer.Specifications.Entities.Role.Manager;
using Persistence.Database.SqlServer.Specifications.Entities.Skill.Manager;
using Persistence.Database.SqlServer.Specifications.Entities.User.Manager;
using Persistence.Database.SqlServer.Specifications.Entities.UserHobby.Manager;
using Persistence.Database.SqlServer.Specifications.Entities.UserJoiningStatus.Manager;
using Persistence.Database.SqlServer.Specifications.Entities.UserPlatform.Manager;
using Persistence.Database.SqlServer.Specifications.Entities.UserSkill.Manager;

namespace Persistence.Database.SqlServer.Specifications.Others;
