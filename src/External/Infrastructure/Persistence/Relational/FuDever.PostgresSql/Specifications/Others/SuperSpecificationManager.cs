...
using FuDever.PostgresSql.Specifications.Entities.Blog.Manager;
using FuDever.PostgresSql.Specifications.Entities.Cv.Manager;
using FuDever.PostgresSql.Specifications.Entities.Department.Manager;
using FuDever.PostgresSql.Specifications.Entities.Hobby.Manager;
using FuDever.PostgresSql.Specifications.Entities.Major.Manager;
using FuDever.PostgresSql.Specifications.Entities.Platform.Manager;
using FuDever.PostgresSql.Specifications.Entities.Position.Manager;
using FuDever.PostgresSql.Specifications.Entities.Project.Manager;
using FuDever.PostgresSql.Specifications.Entities.RefreshToken.Manager;
using FuDever.PostgresSql.Specifications.Entities.Role.Manager;
using FuDever.PostgresSql.Specifications.Entities.Skill.Manager;
using FuDever.PostgresSql.Specifications.Entities.User.Manager;
using FuDever.PostgresSql.Specifications.Entities.UserHobby.Manager;
using FuDever.PostgresSql.Specifications.Entities.UserJoiningStatus.Manager;
using FuDever.PostgresSql.Specifications.Entities.UserPlatform.Manager;
using FuDever.PostgresSql.Specifications.Entities.UserRole.Manager;
using FuDever.PostgresSql.Specifications.Entities.UserSkill.Manager;

namespace FuDever.PostgresSql.Specifications.Others;
